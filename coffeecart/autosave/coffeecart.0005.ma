...
//Name: coffeecart.0005.ma
//Last modified: Wed, Sep 12, 2012 11:41:01 AM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -9.6758848337925265 0.31156674923969341 15.078697020828658 ;
	setAttr ".r" -type "double3" 23.06142411092398 -1115.8000000000141 359.99999999994884 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 17.744841536424254;
...
connectAttr "polyPlanarProj3.out" "polySurfaceShape34.i";
...
connectAttr "polySurfaceShape34.iog" "file1SG.dsm" -na;
