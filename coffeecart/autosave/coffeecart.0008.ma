...
//Name: coffeecart.0008.ma
//Last modified: Wed, Sep 12, 2012 12:12:43 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode polyTweakUV -n "polyTweakUV5";
	setAttr ".uopa" yes;
	setAttr -s 13 ".uvtk";
	setAttr ".uvtk[210]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[211]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[212]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[213]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[214]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[215]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[216]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[217]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[218]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[219]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[220]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvtk[221]" -type "float2" -0.50062782 -0.32975486 ;
	setAttr ".uvs" -type "string" "TOPcart1";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "polyTweakUV5.out" "polySurfaceShape34.i";
